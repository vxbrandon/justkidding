...
def update(num, data, line):
    ...
    # Draw the left and right leg
    line.set_data(xdata, ydata)
    line.set_3d_properties(zdata)

    return line,

# Create a line object for updating
line, = ax.plot([], [], [], 'o-', lw=2)
...
# Create animation
ani = animation.FuncAnimation(fig, update, frames=total_frames, fargs=(landmarks_df, line), interval=interval, blit=False)
